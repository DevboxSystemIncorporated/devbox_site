...
@section('contact')
    ...
    <div class="contact_form_sub_container col-9 col-sm-7 col-md-5 col-lg-4">
            ...
            <div class="form-group">
                {!! Form::select('subject',array('Complete Website'=>'Complete Website','Web Designing'=>'Web Designing','Security'=>'Security','Others'=>'Others','I'=>'---- Inquiry ----'),'I',['class' => 'form-control form-control-sm curved_form']) !!}
            </div>
