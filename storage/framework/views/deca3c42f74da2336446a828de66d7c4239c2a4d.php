...
<?php $__env->startSection('contact'); ?>
    ...
    <div class="contact_form_sub_container col-9 col-sm-7 col-md-5 col-lg-4">
            ...
            <div class="form-group">
                <?php echo Form::select('subject',array('Complete Website'=>'Complete Website','Web Designing'=>'Web Designing','Security'=>'Security','Others'=>'Others','I'=>'---- Inquiry ----'),'I',['class' => 'form-control form-control-sm curved_form']); ?>

            </div>

            <div class="form-group">
                <?php echo Form::textarea('msg', null, ['class' => 'form-control form-control-sm curved_area', 'placeholder' => 'Message','rows' => '3']); ?>
